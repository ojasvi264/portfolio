            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="position-relative">
                        <img src="{{asset('frontend/images/myphoto.jpg')}}" alt="" class="radius-image img-fluid">
                    </div>
                </div>
...
<script src="{{asset('frontend/js/theme-change.js')}}"></script><!-- theme switch js (light and dark)-->

<script src="{{asset('frontend/js/jquery-3.3.1.min.js')}}"></script><!-- default jQuery -->
